...
handlers._users.put = function(data, callback){
  ...
  // console.log("Debugging got to this point fname" , firstName)
  // console.log("Debugging got to this point lname" , lastName)
  // console.log("Debugging got to this point password" , password)
  // console.log("Debugging got to this point phone" , phone)
